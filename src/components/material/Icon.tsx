...
export const Icons = [
  'add', 'arrow_back', 'arrow_upward', 'camera', 'check', 'chevron_right', 'clear', 'close', 'delete', 'description', 'directions_car', 'download', 'error',
  ...
  'login', 'person_off', 'autorenew', 'close_small', 'pause', 'play_arrow', 'clear_all', 'share', 'terminal', 'bolt',
] as const
